...
export branch_front_end=$branch_front_end &&
export subdominio=$subdominio &&

echo "pbi = ${pbi}" &&
echo "branch_back_end = ${branch_back_end}" &&
echo "branch_front_end = ${branch_front_end}" &&
...
if [ -d "$pasta_raiz/$subdominio" ]; then
    ...
    # Deletar a pasta
    sudo rm -rf "$pasta_raiz/$subdominio" &&
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/qacoders-academy.com.br/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/qacoders-academy.com.br/privkey.pem;
    ssl_certificate /etc/letsencrypt/live/qacoders-academy.com.br/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/qacoders-academy.com.br/privkey.pem;
